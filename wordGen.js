...
var consonants = 'bcdefghjklmnpqrstvwxz';
var vowels = 'aeiouy';
var vowAccents = 'áéíýóúàâêîôû';
function sleep(ms) {
...
function formWord(nSylls) {
    var word = '';
    for (var j = 0; j < nSylls; j++) {
        var syll = formSyllable();
        word += syll;
    }
    return word;
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    name_1.push(formWord(nSylls));
                    console.log(name_1.join(' '));
